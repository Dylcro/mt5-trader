...
interface TradingContextValue {
  ...
  placeCascadeOrders: (params: CascadeOrderParams) => Promise<{ success: boolean; placed: number; failed: number; message: string; zoneId: string; marketPositionId?: string; limitOrderIds?: string[] }>;
