...
import { loadCascadeConfig, startAutoConnect, startConnectionWatchdog, startFailsafeScanner } from "./routes/mt5";
...
async function main() {
  ...
  // Failsafe: every 10 s, scan every live connection for naked XAUUSD
  // positions and attach an emergency SL. Safety net for primary auto-SL.
  startFailsafeScanner();
}
