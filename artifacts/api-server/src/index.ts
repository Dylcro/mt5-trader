...
async function ensureTables(): Promise<void> {
  await pool.query(`
    ...
    ALTER TABLE cascade_config ADD COLUMN IF NOT EXISTS tp1_pct INTEGER NOT NULL DEFAULT 25;
    ALTER TABLE cascade_config ADD COLUMN IF NOT EXISTS tp2_pct INTEGER NOT NULL DEFAULT 25;
    ALTER TABLE cascade_config ADD COLUMN IF NOT EXISTS tp3_pct INTEGER NOT NULL DEFAULT 25;
    ALTER TABLE cascade_config ADD COLUMN IF NOT EXISTS tp4_pct INTEGER NOT NULL DEFAULT 25;
    ALTER TABLE cascade_config ADD COLUMN IF NOT EXISTS tp1_enabled BOOLEAN NOT NULL DEFAULT TRUE;
    ALTER TABLE cascade_config ADD COLUMN IF NOT EXISTS tp2_enabled BOOLEAN NOT NULL DEFAULT TRUE;
    ALTER TABLE cascade_config ADD COLUMN IF NOT EXISTS tp3_enabled BOOLEAN NOT NULL DEFAULT TRUE;
    ALTER TABLE cascade_config ADD COLUMN IF NOT EXISTS tp4_enabled BOOLEAN NOT NULL DEFAULT TRUE;
    ALTER TABLE cascade_config ADD COLUMN IF NOT EXISTS risk_free_pips INTEGER NOT NULL DEFAULT -10;
    ALTER TABLE cascade_config ADD COLUMN IF NOT EXISTS auto_be_at_tp INTEGER NOT NULL DEFAULT 2;
    ALTER TABLE cascade_config ADD COLUMN IF NOT EXISTS take_profit_enabled BOOLEAN NOT NULL DEFAULT FALSE;
    ALTER TABLE cascade_config ADD COLUMN IF NOT EXISTS take_profit_pips INTEGER NOT NULL DEFAULT 30;
  `);
  await pool.query(`
